...
def main():
    ...
    print(f"Average Accuracy: {accuracy_cv_nb:.2f}%")
    print(f"Average Precision: {precision_cv_nb:.2f}%")
    print(f"Average Recall: {recall_cv_nb:.2f}%")
    print(f"Average F1-score: {f1_cv_nb:.2f}%\n")
    accuracy_cv_svm, precision_cv_svm, recall_cv_svm, f1_cv_svm = cross_validate_model(svm_classifier, X, y)


    print("Support Vector Machine Classifier Cross-Validation")
    print(f"Average Accuracy: {accuracy_cv_svm:.2f}%")
    print(f"Average Precision: {precision_cv_svm:.2f}%")
    print(f"Average Recall: {recall_cv_svm:.2f}%")
    print(f"Average F1-score: {f1_cv_svm:.2f}%")
