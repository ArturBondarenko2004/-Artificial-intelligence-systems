...
plot_learning_curve(linear_model, X_train, y_train, "Learning Curve (Linear
Regression)")
poly10_model = make_pipeline(PolynomialFeatures(10), LinearRegression())
plot_learning_curve(poly10_model, X_train, y_train, "Learning Curve (Polynomial
Regression, Degree 10)")
poly2_model = make_pipeline(PolynomialFeatures(2), LinearRegression())
plot_learning_curve(poly2_model, X_train, y_train, "Learning Curve (Polynomial
Regression, Degree 2)")
