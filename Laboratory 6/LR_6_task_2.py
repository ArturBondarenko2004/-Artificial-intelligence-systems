...
data = {
    "Outlook": {"Rain": {"Yes": 2, "No": 2}, "Sunny": {"Yes": 3, "No": 2}, "Overcast": {"Yes": 4, "No": 0}},
...
P_Weak_Yes = data["Wind"]["Weak"]["Yes"] / data["Play"]["Yes"]
P_Weak_No = data["Wind"]["Weak"]["No"] / data["Play"]["No"]

# Розрахунок апостеріорних ймовірностей
P_Yes_given_data = P_Rain_Yes * P_High_Yes * P_Weak_Yes * P_Yes
P_No_given_data = P_Rain_No * P_High_No * P_Weak_No * P_No
